export default function MicButton({ active = false, thinking = false, onPress }) {
  ...
  return (
    <button
      ...
      className={[
        'group relative size-16 md:size-20 rounded-full',
        style.bg,
        style.border,
    ...
    >
      ...
      {thinking && (
        <>
          <span className="pointer-events-none absolute inset-0 rounded-full animate-spin bg-gradient-conic from-purple-400/30 via-indigo-400/20 to-purple-400/30" style={{ animationDuration: '3s' }} />
